...
<em>Neurocomputing</em>, <strong>147</strong>, 15-30.</li>'
  ...
  mainPanel(
    ...
    proceed).'
      ...
      #### Panel 'Self-organize'
      #########################################################################2
      bsCollapsePanel(title = "3. Train the self-organizing map", value="bscoll3",
        p(
          HTML(
            "Once your dataset is imported, you can train a
...
<a href= #externalinfo> Combine with external information</a> <br />"
        ...
        p(HTML(
          "<h3 id=somtype> Types of self-organizing maps</h3>"
        )),
        p(
          HTML(
...
'http://www-personal.umich.edu/~mejn/netdata/lesmis.zip'>here</a>."
        ...
        p(HTML(
          "<h3 id=importdata> Data importation</h3>"
        )),
        p(
          HTML(
...
dendrogram)."
        ...
        p(
          HTML("<h3 id=externalinfo> Combine with external
                      information</h3>")
        ),
        p(
          HTML(
