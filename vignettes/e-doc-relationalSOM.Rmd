...
plot(sc.mis)
plot(sc.mis, what="prototypes", type="grid", plot.legend=TRUE)
plot(sc.mis, what="prototypes", type="lines", print.title=TRUE)
plot(sc.mis, what="prototypes", type="mds", plot.legend=TRUE)
