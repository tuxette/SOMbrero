...
by a hitmap:
```{r presiHitmap}
plot(korresp.som, what="obs", type="hitmap", show.names = F)
```
...
plot(korresp.som, what="prototypes", type="lines", view="r", show.names=F) +    
...
plot(korresp.som, what="prototypes", type="lines", view="c", show.names=F) +
...
```{r presiGraphProto2}
plot(korresp.som, what="prototypes", type="poly.dist", show.names=F)
...
```{r presiSC4}
plot(my.sc, what="prototypes", type="hitmap")
plot(my.sc, what="prototypes", type="lines", show.names=F, view="c")
