...
plot(korresp.som, what="prototypes", type="lines", view="r", print.title=F) +    
  guides(color=guide_legend(keywidth=0.1, keyheight=0.1, default.unit="cm", ncol=3)) + 
  theme(legend.text=element_text(size=3))
# plot the column prototypes (16 candidates)
plot(korresp.som, what="prototypes", type="lines", view="c", print.title=F) +
...
```{r presiProtoNumber, fig.width=12, fig.height=6, fig.show='hold', out.width="50%"}
# par(mfrow=c(1,2))
...
```{r presiSC4}
plot(my.sc, what="prototypes", type="hitmap", plot.legend=TRUE)
plot(my.sc, what="prototypes", type="lines", print.title=F)
plot(my.sc, what="prototypes", type="lines", print.title=F, view="c")
plot(my.sc, what="prototypes", type="mds", plot.legend=TRUE)
```
